  ...
  final Map<String, _i17.PageFactory> pagesMap = {
    SignUpWrapperRoute.name: (routeData) {
      return _i17.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: _i17.WrappedRoute(child: const _i1.SignUpWrapperPage()),
      );
    },
...
class SignUpWrapperRoute extends _i17.PageRouteInfo<void> {
  const SignUpWrapperRoute({List<_i17.PageRouteInfo>? children})
      : super(
...
/// generated route for
/// [_i3.EnterPhonePage]
class EnterPhoneRoute extends _i17.PageRouteInfo<void> {
  const EnterPhoneRoute({List<_i17.PageRouteInfo>? children})
      : super(
...
/// generated route for
/// [_i4.LogInCheckPage]
class LogInCheckRoute extends _i17.PageRouteInfo<void> {
  const LogInCheckRoute({List<_i17.PageRouteInfo>? children})
      : super(
...
class ForgotPinOtpWrapperRoute extends _i17.PageRouteInfo<void> {
  const ForgotPinOtpWrapperRoute({List<_i17.PageRouteInfo>? children})
      : super(
...
class PickUpSpecialistRoute extends _i17.PageRouteInfo<void> {
  const PickUpSpecialistRoute({List<_i17.PageRouteInfo>? children})
      : super(
...
class SpecialistDetailsRoute
    extends _i17.PageRouteInfo<SpecialistDetailsRouteArgs> {
  SpecialistDetailsRoute({
    _i18.Key? key,
    required _i19.SpecialistModel specialistModel,
  ...
  static const _i17.PageInfo<SpecialistDetailsRouteArgs> page =
      _i17.PageInfo<SpecialistDetailsRouteArgs>(name);
}
...
class SpecialistDetailsRouteArgs {
  ...
  final _i19.SpecialistModel specialistModel;
