...
abstract class $SpecialistModelDtoCopyWith<$Res> {
  ...
  $Res call(
      ...
      String lastName,
      int price,
      @JsonKey(fromJson: DateUtils.convertToDateTime) DateTime experience,
      double rating,
      int reviewCount,
...
class _$_SpecialistModelDto
  ...
  const _$_SpecialistModelDto(
      ...
      required this.price,
      @JsonKey(fromJson: DateUtils.convertToDateTime) required this.experience,
      this.rating = 0.0,
      this.reviewCount = 0,
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'SpecialistModelDto(id: $id, firstName: $firstName, lastName: $lastName, price: $price, experience: $experience, rating: $rating, reviewCount: $reviewCount, specializations: $specializations, photoUrl: $photoUrl, about: $about, education: $education)';
  }
...
abstract class _SpecialistModelDto implements SpecialistModelDto {
  const factory _SpecialistModelDto(
      ...
      final String? photoUrl,
      final String? about,
      final String? education}) = _$_SpecialistModelDto;
