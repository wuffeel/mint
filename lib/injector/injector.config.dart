...
import 'package:mint/assembly/entity/review_model_from_dto.dart' as _i50;
...
import 'package:mint/bloc/favorite/favorite_bloc.dart' as _i67;
...
import 'package:mint/bloc/review/review_bloc.dart' as _i64;
...
import 'package:mint/bloc/specialist_online/specialist_online_bloc.dart'
    as _i66;
import 'package:mint/bloc/user/user_bloc.dart' as _i56;
...
import 'package:mint/data/model/pick_up_filter_dto/pick_up_filter_dto.dart'
    as _i12;
import 'package:mint/data/model/review_model_dto/review_model_dto.dart' as _i49;
...
import 'package:mint/domain/entity/review_model/review_model.dart' as _i48;
...
import 'package:mint/domain/service/abstract/specialist_service.dart' as _i54;
import 'package:mint/domain/service/abstract/storage_service.dart' as _i27;
import 'package:mint/domain/service/abstract/user_service.dart' as _i46;
...
import 'package:mint/domain/service/firebase/firebase_user_service.dart'
    as _i47;
import 'package:mint/domain/usecase/add_to_favorite_use_case.dart' as _i57;
import 'package:mint/domain/usecase/fetch_favorite_list_use_case.dart' as _i58;
...
import 'package:mint/domain/usecase/fetch_specialists_online_use_case.dart'
    as _i61;
import 'package:mint/domain/usecase/get_current_user_use_case.dart' as _i51;
import 'package:mint/domain/usecase/log_out_use_case.dart' as _i52;
import 'package:mint/domain/usecase/pin_code_change_use_case.dart' as _i53;
import 'package:mint/domain/usecase/remove_from_favorite_use_case.dart' as _i63;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.factory<_i46.UserService>(() => _i47.FirebaseUserService(
          gh<_i30.UserRepository>(),
          gh<_i4.Factory<_i35.Future<_i36.UserModel>, _i37.UserModelDto>>(),
        ));
    gh.factory<
            _i4.Factory<_i35.Future<_i48.ReviewModel?>, _i49.ReviewModelDto>>(
        () => _i50.ReviewModelFromDto(gh<_i46.UserService>()));
    gh.factory<_i51.GetCurrentUserUseCase>(
        () => _i51.GetCurrentUserUseCase(gh<_i46.UserService>()));
    gh.factory<_i52.LogOutUseCase>(
        () => _i52.LogOutUseCase(gh<_i46.UserService>()));
    gh.factory<_i53.PinCodeChangeUseCase>(
        () => _i53.PinCodeChangeUseCase(gh<_i46.UserService>()));
    gh.factory<_i54.SpecialistService>(() => _i55.FirebaseSpecialistService(
          ...
          gh<
              _i4.Factory<_i35.Future<_i48.ReviewModel?>,
                  _i49.ReviewModelDto>>(),
        ));
    gh.factory<_i56.UserBloc>(() => _i56.UserBloc(
          gh<_i51.GetCurrentUserUseCase>(),
          gh<_i52.LogOutUseCase>(),
          gh<_i29.UserController>(),
        ));
    gh.factory<_i57.AddToFavoriteUseCase>(
        () => _i57.AddToFavoriteUseCase(gh<_i54.SpecialistService>()));
    gh.factory<_i58.FetchFavoriteListUseCase>(
        () => _i58.FetchFavoriteListUseCase(gh<_i54.SpecialistService>()));
    gh.factory<_i59.FetchSpecialistCatalogueUseCase>(() =>
        _i59.FetchSpecialistCatalogueUseCase(gh<_i54.SpecialistService>()));
    gh.factory<_i60.FetchSpecialistReviewsUseCase>(
        () => _i60.FetchSpecialistReviewsUseCase(gh<_i54.SpecialistService>()));
    gh.factory<_i61.FetchSpecialistsOnlineUseCase>(
        () => _i61.FetchSpecialistsOnlineUseCase(gh<_i54.SpecialistService>()));
    gh.factory<_i62.PinCodeBloc>(() => _i62.PinCodeBloc(
          gh<_i29.UserController>(),
          gh<_i53.PinCodeChangeUseCase>(),
        ));
    gh.factory<_i63.RemoveFromFavoriteUseCase>(
        () => _i63.RemoveFromFavoriteUseCase(gh<_i54.SpecialistService>()));
    gh.factory<_i64.ReviewBloc>(() => _i64.ReviewBloc(
          gh<_i60.FetchSpecialistReviewsUseCase>(),
          gh<_i29.UserController>(),
        ));
    gh.factory<_i65.SpecialistCatalogueBloc>(() => _i65.SpecialistCatalogueBloc(
          gh<_i59.FetchSpecialistCatalogueUseCase>(),
          gh<_i3.AppliedFilterController>(),
        ));
    gh.factory<_i66.SpecialistOnlineBloc>(() =>
        _i66.SpecialistOnlineBloc(gh<_i61.FetchSpecialistsOnlineUseCase>()));
    gh.factory<_i67.FavoriteBloc>(() => _i67.FavoriteBloc(
          gh<_i29.UserController>(),
          gh<_i58.FetchFavoriteListUseCase>(),
          gh<_i57.AddToFavoriteUseCase>(),
          gh<_i63.RemoveFromFavoriteUseCase>(),
        ));
    return this;
  }
}
