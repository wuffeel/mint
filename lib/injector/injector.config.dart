...
import 'package:mint/assembly/entity/specialist_model_from_dto.dart' as _i67;
...
import 'package:mint/assembly/entity/upcoming_consultation_data_from_dto.dart'
    as _i89;
import 'package:mint/assembly/entity/user_model_from_dto.dart' as _i64;
...
import 'package:mint/bloc/booking/booking_bloc.dart' as _i106;
...
import 'package:mint/data/model/upcoming_consultation_data_dto/upcoming_consultation_data_dto.dart'
    as _i88;
import 'package:mint/data/model/user_model_dto/user_model_dto.dart' as _i63;
...
import 'package:mint/domain/entity/upcoming_consultation_data/upcoming_consultation_data.dart'
    as _i87;
import 'package:mint/domain/entity/user_model/user_model.dart' as _i62;
import 'package:mint/domain/service/abstract/booking_service.dart' as _i99;
...
import 'package:mint/domain/usecase/fetch_favorite_list_use_case.dart' as _i90;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.factory<_i6.Factory<_i16.ReviewModelDto, _i17.ReviewModel>>(
        () => _i18.ReviewModelToDto());
    gh.factory<_i6.Factory<_i19.FilterPreferencesDto, _i20.FilterPreferences>>(
        () => _i21.FilterPreferencesToDto());
    gh.factory<_i6.Factory<_i11.BookingData, _i10.BookingDataDto>>(
        () => _i22.BookingDataFromDto());
    gh.factory<_i6.Factory<_i23.TransactionDataDto, _i24.TransactionData>>(
    ...
    gh.factory<_i6.Factory<_i29.PickUpFilter, _i30.PickUpFilterDto>>(
    ...
    gh.factory<_i34.FilterService>(() => _i35.FirebaseFilterService(
          ...
          gh<_i6.Factory<_i29.PickUpFilter, _i30.PickUpFilterDto>>(),
        ));
    ...
    gh.factory<_i38.PaymentService>(() => _i39.FirebasePaymentService(
          ...
          gh<_i6.Factory<_i23.TransactionDataDto, _i24.TransactionData>>(),
        ));
    ...
    gh.factory<_i6.Factory<_i61.Future<_i62.UserModel>, _i63.UserModelDto>>(
        () => _i64.UserModelFromDto(gh<_i50.StorageService>()));
    gh.factory<
            _i6.Factory<_i61.Future<_i65.SpecialistModel>,
                _i66.SpecialistModelDto>>(
        () => _i67.SpecialistModelFromDto(gh<_i50.StorageService>()));
    ...
    gh.factory<_i73.UserService>(() => _i74.FirebaseUserService(
          ...
          gh<_i6.Factory<_i61.Future<_i62.UserModel>, _i63.UserModelDto>>(),
        ));
    ...
    gh.factory<
            _i6.Factory<_i61.Future<_i17.ReviewModel?>, _i16.ReviewModelDto>>(
    ...
    gh.factory<_i80.SpecialistService>(() => _i81.FirebaseSpecialistService(
          ...
          gh<
              _i6.Factory<_i61.Future<_i65.SpecialistModel>,
                  _i66.SpecialistModelDto>>(),
          gh<_i6.Factory<_i19.FilterPreferencesDto, _i20.FilterPreferences>>(),
          gh<
              _i6.Factory<_i61.Future<_i17.ReviewModel?>,
                  _i16.ReviewModelDto>>(),
          gh<_i6.Factory<_i16.ReviewModelDto, _i17.ReviewModel>>(),
        ));
    ...
    gh.factory<
        _i6.Factory<_i61.Future<_i87.UpcomingConsultationData?>,
            _i88.UpcomingConsultationDataDto>>(() =>
        _i89.UpcomingConsultationDataFromDto(gh<_i80.SpecialistService>()));
    gh.factory<_i90.FetchFavoriteListUseCase>(
        () => _i90.FetchFavoriteListUseCase(gh<_i80.SpecialistService>()));
    gh.factory<_i91.FetchSpecialistCatalogueUseCase>(() =>
        _i91.FetchSpecialistCatalogueUseCase(gh<_i80.SpecialistService>()));
    gh.factory<_i92.FetchSpecialistReviewsUseCase>(
        () => _i92.FetchSpecialistReviewsUseCase(gh<_i80.SpecialistService>()));
    gh.factory<_i93.FetchSpecialistsOnlineUseCase>(
        () => _i93.FetchSpecialistsOnlineUseCase(gh<_i80.SpecialistService>()));
    gh.factory<_i94.PinCodeBloc>(() => _i94.PinCodeBloc(
          gh<_i53.UserController>(),
          gh<_i79.PinCodeChangeUseCase>(),
        ));
    gh.factory<_i95.RemoveFromFavoriteUseCase>(
        () => _i95.RemoveFromFavoriteUseCase(gh<_i80.SpecialistService>()));
    gh.factory<_i96.ReviewBloc>(() => _i96.ReviewBloc(
          gh<_i92.FetchSpecialistReviewsUseCase>(),
    ...
    gh.factory<_i97.SpecialistCatalogueBloc>(() => _i97.SpecialistCatalogueBloc(
          gh<_i91.FetchSpecialistCatalogueUseCase>(),
          gh<_i3.AppliedFilterController>(),
          gh<_i45.SpecialistRatingController>(),
        ));
    gh.factory<_i98.SpecialistOnlineBloc>(() => _i98.SpecialistOnlineBloc(
          gh<_i93.FetchSpecialistsOnlineUseCase>(),
          gh<_i45.SpecialistRatingController>(),
        ));
    gh.factory<_i99.BookingService>(() => _i100.FirebaseBookingService(
          ...
          gh<_i6.Factory<_i11.BookingData, _i10.BookingDataDto>>(),
          gh<
              _i6.Factory<_i61.Future<_i87.UpcomingConsultationData?>,
                  _i88.UpcomingConsultationDataDto>>(),
        ));
    gh.factory<_i101.FavoriteBloc>(() => _i101.FavoriteBloc(
          gh<_i53.UserController>(),
          gh<_i90.FetchFavoriteListUseCase>(),
          gh<_i85.AddToFavoriteUseCase>(),
          gh<_i95.RemoveFromFavoriteUseCase>(),
        ));
    gh.factory<_i102.FetchUpcomingConsultationsUseCase>(() =>
        _i102.FetchUpcomingConsultationsUseCase(gh<_i99.BookingService>()));
    gh.factory<_i103.SpecialistWorkInfoFetchUseCase>(
        () => _i103.SpecialistWorkInfoFetchUseCase(gh<_i99.BookingService>()));
    gh.factory<_i104.UpcomingConsultationsBloc>(
        () => _i104.UpcomingConsultationsBloc(
              gh<_i102.FetchUpcomingConsultationsUseCase>(),
              gh<_i53.UserController>(),
            ));
    gh.factory<_i105.BookingBookUseCase>(
        () => _i105.BookingBookUseCase(gh<_i99.BookingService>()));
    gh.factory<_i106.BookingBloc>(() => _i106.BookingBloc(
          gh<_i53.UserController>(),
