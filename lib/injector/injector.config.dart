...
import 'package:mint/assembly/entity/booking_data_from_dto.dart' as _i19;
import 'package:mint/assembly/entity/credit_card_model_from_dto.dart' as _i16;
...
import 'package:mint/assembly/entity/session_data_from_dto.dart' as _i90;
import 'package:mint/assembly/entity/specialist_filter_from_dto.dart' as _i13;
import 'package:mint/assembly/entity/specialist_model_from_dto.dart' as _i65;
import 'package:mint/assembly/entity/specialist_work_info_from_dto.dart'
    as _i28;
import 'package:mint/assembly/entity/user_model_from_dto.dart' as _i68;
import 'package:mint/assembly/factory.dart' as _i7;
import 'package:mint/assembly/model/booking_data_to_dto.dart' as _i29;
...
import 'package:mint/data/model/booking_data_dto/booking_data_dto.dart' as _i18;
...
import 'package:mint/data/model/session_data_dto/session_data_dto.dart' as _i89;
...
import 'package:mint/data/model/transaction_data_dto/transaction_data_dto.dart'
    as _i20;
import 'package:mint/data/model/user_model_dto/user_model_dto.dart' as _i67;
...
import 'package:mint/domain/entity/session_data/session_data.dart' as _i88;
...
import 'package:mint/domain/entity/transaction_data/transaction_data.dart'
    as _i21;
import 'package:mint/domain/entity/user_model/user_model.dart' as _i66;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.factory<_i7.Factory<_i14.CreditCardModel, _i15.CreditCardModelDto>>(
        () => _i16.CreditCardModelFromDto());
    gh.factory<_i7.Factory<_i17.BookingData, _i18.BookingDataDto>>(
        () => _i19.BookingDataFromDto());
    gh.factory<_i7.Factory<_i20.TransactionDataDto, _i21.TransactionData>>(
        () => _i22.TransactionDataToDto());
    gh.factory<_i7.Factory<_i23.FilterPreferencesDto, _i24.FilterPreferences>>(
        () => _i25.FilterPreferencesToDto());
    gh.factory<
            _i7.Factory<_i26.SpecialistWorkInfo, _i27.SpecialistWorkInfoDto>>(
        () => _i28.SpecialistWorkInfoFromDto());
    gh.factory<_i7.Factory<_i18.BookingDataDto, _i17.BookingData>>(
        () => _i29.BookingDataToDto());
    gh.factory<_i7.Factory<_i30.ReviewModelDto, _i31.ReviewModel>>(
    ...
    gh.factory<_i39.PaymentService>(() => _i40.FirebasePaymentService(
          ...
          gh<_i7.Factory<_i14.CreditCardModel, _i15.CreditCardModelDto>>(),
    ...
    gh.factory<
            _i7.Factory<_i62.Future<_i63.SpecialistModel>,
                _i64.SpecialistModelDto>>(
        () => _i65.SpecialistModelFromDto(gh<_i51.StorageService>()));
    gh.factory<_i7.Factory<_i62.Future<_i66.UserModel>, _i67.UserModelDto>>(
        () => _i68.UserModelFromDto(gh<_i51.StorageService>()));
    ...
    gh.factory<_i74.UserService>(() => _i75.FirebaseUserService(
          ...
          gh<_i7.Factory<_i62.Future<_i66.UserModel>, _i67.UserModelDto>>(),
        ));
    ...
    gh.factory<
            _i7.Factory<_i62.Future<_i31.ReviewModel?>, _i30.ReviewModelDto>>(
    ...
    gh.factory<_i81.SpecialistService>(() => _i82.FirebaseSpecialistService(
          ...
          gh<
              _i7.Factory<_i62.Future<_i63.SpecialistModel>,
                  _i64.SpecialistModelDto>>(),
          gh<_i7.Factory<_i23.FilterPreferencesDto, _i24.FilterPreferences>>(),
          gh<
              _i7.Factory<_i62.Future<_i31.ReviewModel?>,
                  _i30.ReviewModelDto>>(),
          gh<_i7.Factory<_i30.ReviewModelDto, _i31.ReviewModel>>(),
        ));
    ...
    gh.factory<
            _i7.Factory<_i62.Future<_i88.SessionData?>, _i89.SessionDataDto>>(
        () => _i90.SessionDataFromDto(gh<_i81.SpecialistService>()));
    ...
    gh.factory<_i100.BookingService>(() => _i101.FirebaseBookingService(
          ...
          gh<_i7.Factory<_i18.BookingDataDto, _i17.BookingData>>(),
          gh<_i7.Factory<_i17.BookingData, _i18.BookingDataDto>>(),
          gh<
              _i7.Factory<_i62.Future<_i88.SessionData?>,
                  _i89.SessionDataDto>>(),
        ));
    ...
    gh.factory<_i103.FetchUpcomingSessionsUseCase>(
        () => _i103.FetchUpcomingSessionsUseCase(gh<_i100.BookingService>()));
    gh.factory<_i104.SpecialistWorkInfoFetchUseCase>(
        () => _i104.SpecialistWorkInfoFetchUseCase(gh<_i100.BookingService>()));
    gh.factory<_i105.UpcomingSessionsBloc>(() => _i105.UpcomingSessionsBloc(
          gh<_i103.FetchUpcomingSessionsUseCase>(),
          gh<_i54.UserController>(),
