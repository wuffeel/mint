...
import 'package:mint/assembly/entity/booking_data_from_dto.dart' as _i31;
import 'package:mint/assembly/entity/credit_card_model_from_dto.dart' as _i12;
...
import 'package:mint/assembly/entity/specialist_model_from_dto.dart' as _i69;
import 'package:mint/assembly/entity/specialist_work_info_from_dto.dart'
    as _i30;
import 'package:mint/assembly/entity/user_model_from_dto.dart' as _i66;
import 'package:mint/assembly/factory.dart' as _i6;
import 'package:mint/assembly/model/booking_data_to_dto.dart' as _i27;
...
import 'package:mint/data/model/booking_data_dto/booking_data_dto.dart' as _i25;
...
import 'package:mint/data/model/transaction_data_dto/transaction_data_dto.dart'
    as _i19;
import 'package:mint/data/model/user_model_dto/user_model_dto.dart' as _i65;
...
import 'package:mint/domain/entity/transaction_data/transaction_data.dart'
    as _i20;
import 'package:mint/domain/entity/user_model/user_model.dart' as _i64;
...
import 'package:mint/domain/service/abstract/user_service.dart' as _i76;
...
import 'package:mint/domain/usecase/booking_book_use_case.dart' as _i78;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.factory<_i6.Factory<_i10.CreditCardModel, _i11.CreditCardModelDto>>(
        () => _i12.CreditCardModelFromDto());
    ...
    gh.factory<_i6.Factory<_i19.TransactionDataDto, _i20.TransactionData>>(
    ...
    gh.factory<_i6.Factory<_i25.BookingDataDto, _i26.BookingData>>(
        () => _i27.BookingDataToDto());
    gh.factory<
            _i6.Factory<_i28.SpecialistWorkInfo, _i29.SpecialistWorkInfoDto>>(
        () => _i30.SpecialistWorkInfoFromDto());
    gh.factory<_i6.Factory<_i26.BookingData, _i25.BookingDataDto>>(
        () => _i31.BookingDataFromDto());
    ...
    gh.factory<_i38.PaymentService>(() => _i39.FirebasePaymentService(
          ...
          gh<_i6.Factory<_i10.CreditCardModel, _i11.CreditCardModelDto>>(),
          gh<_i6.Factory<_i19.TransactionDataDto, _i20.TransactionData>>(),
        ));
    ...
    gh.factory<_i59.BookingService>(() => _i60.FirebaseBookingService(
          ...
          gh<
              _i6.Factory<_i28.SpecialistWorkInfo,
                  _i29.SpecialistWorkInfoDto>>(),
          gh<_i6.Factory<_i25.BookingDataDto, _i26.BookingData>>(),
          gh<_i6.Factory<_i26.BookingData, _i25.BookingDataDto>>(),
        ));
    ...
    gh.factory<_i6.Factory<_i63.Future<_i64.UserModel>, _i65.UserModelDto>>(
        () => _i66.UserModelFromDto(gh<_i50.StorageService>()));
    gh.factory<
            _i6.Factory<_i63.Future<_i67.SpecialistModel>,
                _i68.SpecialistModelDto>>(
        () => _i69.SpecialistModelFromDto(gh<_i50.StorageService>()));
    ...
    gh.factory<_i74.SpecialistWorkInfoFetchUseCase>(
        () => _i74.SpecialistWorkInfoFetchUseCase(gh<_i59.BookingService>()));
    gh.factory<_i75.TransactionBloc>(() => _i75.TransactionBloc(
          gh<_i52.TransactionPayUseCase>(),
          gh<_i53.UserController>(),
        ));
    gh.factory<_i76.UserService>(() => _i77.FirebaseUserService(
          gh<_i54.UserRepository>(),
          gh<_i6.Factory<_i63.Future<_i64.UserModel>, _i65.UserModelDto>>(),
        ));
    gh.factory<_i78.BookingBookUseCase>(
        () => _i78.BookingBookUseCase(gh<_i59.BookingService>()));
    ...
    gh.factory<
            _i6.Factory<_i63.Future<_i14.ReviewModel?>, _i13.ReviewModelDto>>(
        () => _i80.ReviewModelFromDto(gh<_i76.UserService>()));
    gh.factory<_i81.GetCurrentUserUseCase>(
        () => _i81.GetCurrentUserUseCase(gh<_i76.UserService>()));
    gh.factory<_i82.LogOutUseCase>(
        () => _i82.LogOutUseCase(gh<_i76.UserService>()));
    gh.factory<_i83.PinCodeChangeUseCase>(
        () => _i83.PinCodeChangeUseCase(gh<_i76.UserService>()));
    gh.factory<_i84.SpecialistService>(() => _i85.FirebaseSpecialistService(
          ...
          gh<
              _i6.Factory<_i63.Future<_i14.ReviewModel?>,
                  _i13.ReviewModelDto>>(),
    ...
    gh.factory<_i90.BookingBloc>(() => _i90.BookingBloc(
          gh<_i53.UserController>(),
          gh<_i74.SpecialistWorkInfoFetchUseCase>(),
          gh<_i78.BookingBookUseCase>(),
        ));
