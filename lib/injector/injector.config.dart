...
import 'package:mint/domain/usecase/booking_book_use_case.dart' as _i103;
import 'package:mint/domain/usecase/booking_cancel_use_case.dart' as _i104;
import 'package:mint/domain/usecase/booking_reschedule_use_case.dart' as _i105;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.factory<_i7.Factory<_i20.CreditCardModel, _i21.CreditCardModelDto>>(
    ...
    gh.factory<_i38.PaymentService>(() => _i39.FirebasePaymentService(
          ...
          gh<_i7.Factory<_i20.CreditCardModel, _i21.CreditCardModelDto>>(),
    ...
    gh.factory<
            _i7.Factory<_i61.Future<_i18.BookingData?>, _i17.BookingDataDto>>(
    ...
    gh.factory<_i97.BookingService>(() => _i98.FirebaseBookingService(
          ...
          gh<
              _i7.Factory<_i61.Future<_i18.BookingData?>,
                  _i17.BookingDataDto>>(),
        ));
    ...
    gh.factory<_i100.FetchUpcomingSessionsUseCase>(
        () => _i100.FetchUpcomingSessionsUseCase(gh<_i97.BookingService>()));
    gh.factory<_i101.SpecialistWorkInfoFetchUseCase>(
        () => _i101.SpecialistWorkInfoFetchUseCase(gh<_i97.BookingService>()));
    gh.factory<_i102.UpcomingSessionsBloc>(() => _i102.UpcomingSessionsBloc(
          gh<_i100.FetchUpcomingSessionsUseCase>(),
          gh<_i53.UserController>(),
          gh<_i4.BookingController>(),
        ));
    gh.factory<_i103.BookingBookUseCase>(
        () => _i103.BookingBookUseCase(gh<_i97.BookingService>()));
    gh.factory<_i104.BookingCancelUseCase>(
        () => _i104.BookingCancelUseCase(gh<_i97.BookingService>()));
    gh.factory<_i105.BookingRescheduleUseCase>(
        () => _i105.BookingRescheduleUseCase(gh<_i97.BookingService>()));
    gh.factory<_i106.BookingBloc>(() => _i106.BookingBloc(
          gh<_i101.SpecialistWorkInfoFetchUseCase>(),
          gh<_i103.BookingBookUseCase>(),
          gh<_i105.BookingRescheduleUseCase>(),
          gh<_i104.BookingCancelUseCase>(),
          gh<_i53.UserController>(),
          gh<_i4.BookingController>(),
        ));
    return this;
