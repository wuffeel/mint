...
import 'package:mint/assembly/entity/booking_data_from_dto.dart' as _i96;
import 'package:mint/assembly/entity/chat_user_data_from_map.dart' as _i30;
import 'package:mint/assembly/entity/credit_card_model_from_dto.dart' as _i13;
import 'package:mint/assembly/entity/pick_up_filter_from_dto.dart' as _i28;
import 'package:mint/assembly/entity/review_model_from_dto.dart' as _i85;
import 'package:mint/assembly/entity/specialist_filter_from_dto.dart' as _i22;
import 'package:mint/assembly/entity/specialist_model_from_dto.dart' as _i75;
import 'package:mint/assembly/entity/specialist_work_info_from_dto.dart'
    as _i19;
import 'package:mint/assembly/entity/user_model_from_dto.dart' as _i72;
import 'package:mint/assembly/factory.dart' as _i7;
import 'package:mint/assembly/model/booking_data_to_dto.dart' as _i10;
import 'package:mint/assembly/model/filter_preferences_to_dto.dart' as _i33;
...
import 'package:mint/bloc/booking/booking_bloc.dart' as _i118;
import 'package:mint/bloc/chat/chat_bloc.dart' as _i83;
import 'package:mint/bloc/credit_card/credit_card_bloc.dart' as _i84;
import 'package:mint/bloc/favorite/favorite_bloc.dart' as _i108;
import 'package:mint/bloc/pick_up_specialist/pick_up_specialist_bloc.dart'
    as _i78;
import 'package:mint/bloc/pin_code/pin_code_bloc.dart' as _i101;
import 'package:mint/bloc/previous_sessions/previous_sessions_bloc.dart'
    as _i111;
import 'package:mint/bloc/review/review_bloc.dart' as _i103;
...
import 'package:mint/bloc/specialist_online/specialist_online_bloc.dart'
    as _i105;
import 'package:mint/bloc/transaction/transaction_bloc.dart' as _i80;
import 'package:mint/bloc/upcoming_sessions/upcoming_sessions_bloc.dart'
    as _i113;
import 'package:mint/bloc/user/user_bloc.dart' as _i92;
import 'package:mint/bloc/work_info/work_info_bloc.dart' as _i114;
...
import 'package:mint/data/model/transaction_data_dto/transaction_data_dto.dart'
    as _i14;
import 'package:mint/data/model/user_model_dto/user_model_dto.dart' as _i71;
import 'package:mint/data/repository/abstract/booking_repository.dart' as _i5;
import 'package:mint/data/repository/abstract/chat_repository.dart' as _i63;
...
import 'package:mint/domain/entity/transaction_data/transaction_data.dart'
    as _i15;
import 'package:mint/domain/entity/user_model/user_model.dart' as _i70;
import 'package:mint/domain/service/abstract/booking_service.dart' as _i106;
import 'package:mint/domain/service/abstract/chat_service.dart' as _i65;
...
import 'package:mint/domain/service/abstract/specialist_service.dart' as _i89;
import 'package:mint/domain/service/abstract/storage_service.dart' as _i54;
import 'package:mint/domain/service/abstract/user_service.dart' as _i81;
...
import 'package:mint/domain/service/firebase/firebase_user_service.dart'
    as _i82;
import 'package:mint/domain/usecase/add_review_use_case.dart' as _i93;
import 'package:mint/domain/usecase/add_to_favorite_use_case.dart' as _i94;
import 'package:mint/domain/usecase/booking_book_use_case.dart' as _i115;
import 'package:mint/domain/usecase/booking_cancel_use_case.dart' as _i116;
import 'package:mint/domain/usecase/booking_reschedule_use_case.dart' as _i117;
import 'package:mint/domain/usecase/credit_card_list_fetch_use_case.dart'
    as _i67;
import 'package:mint/domain/usecase/credit_card_save_use_case.dart' as _i68;
import 'package:mint/domain/usecase/delete_review_use_case.dart' as _i95;
import 'package:mint/domain/usecase/fetch_favorite_list_use_case.dart' as _i97;
import 'package:mint/domain/usecase/fetch_pick_up_filter_use_case.dart' as _i76;
...
import 'package:mint/domain/usecase/fetch_upcoming_sessions_use_case.dart'
    as _i110;
import 'package:mint/domain/usecase/get_current_user_use_case.dart' as _i86;
import 'package:mint/domain/usecase/log_out_use_case.dart' as _i87;
import 'package:mint/domain/usecase/pin_code_change_use_case.dart' as _i88;
...
import 'package:mint/domain/usecase/update_review_use_case.dart' as _i91;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.factory<_i7.Factory<_i11.CreditCardModel, _i12.CreditCardModelDto>>(
        () => _i13.CreditCardModelFromDto());
    gh.factory<_i7.Factory<_i14.TransactionDataDto, _i15.TransactionData>>(
        () => _i16.TransactionDataToDto());
    gh.factory<
            _i7.Factory<_i17.SpecialistWorkInfo, _i18.SpecialistWorkInfoDto>>(
        () => _i19.SpecialistWorkInfoFromDto());
    gh.factory<_i7.Factory<_i20.SpecialistFilter, _i21.SpecialistFilterDto>>(
        () => _i22.SpecialistFilterFromDto());
    gh.factory<_i7.Factory<_i23.ReviewModelDto, _i24.ReviewModel>>(
        () => _i25.ReviewModelToDto());
    gh.factory<_i7.Factory<_i26.PickUpFilter, _i27.PickUpFilterDto>>(
        () => _i28.PickUpFilterFromDto());
    gh.factory<_i7.Factory<_i29.User, Map<String, dynamic>>>(
        () => _i30.ChatUserDataFromMap());
    gh.factory<_i7.Factory<_i31.FilterPreferencesDto, _i32.FilterPreferences>>(
        () => _i33.FilterPreferencesToDto());
    ...
    gh.factory<_i38.FilterService>(() => _i39.FirebaseFilterService(
          ...
          gh<_i7.Factory<_i20.SpecialistFilter, _i21.SpecialistFilterDto>>(),
          gh<_i7.Factory<_i26.PickUpFilter, _i27.PickUpFilterDto>>(),
        ));
    ...
    gh.factory<_i42.PaymentService>(() => _i43.FirebasePaymentService(
          ...
          gh<_i7.Factory<_i11.CreditCardModel, _i12.CreditCardModelDto>>(),
    ...
    gh.factory<_i63.ChatRepository>(() => _i64.FirebaseChatRepository(
        gh<_i7.Factory<_i29.User, Map<String, dynamic>>>()));
    gh.factory<_i65.ChatService>(() => _i66.FirebaseChatService(
          gh<_i63.ChatRepository>(),
          gh<_i54.StorageService>(),
        ));
    gh.factory<_i67.CreditCardListFetchUseCase>(
        () => _i67.CreditCardListFetchUseCase(gh<_i42.PaymentService>()));
    gh.factory<_i68.CreditCardSaveUseCase>(
        () => _i68.CreditCardSaveUseCase(gh<_i42.PaymentService>()));
    gh.factory<_i7.Factory<_i69.Future<_i70.UserModel>, _i71.UserModelDto>>(
        () => _i72.UserModelFromDto(gh<_i54.StorageService>()));
    gh.factory<
            _i7.Factory<_i69.Future<_i73.SpecialistModel>,
                _i74.SpecialistModelDto>>(
        () => _i75.SpecialistModelFromDto(gh<_i54.StorageService>()));
    gh.factory<_i76.FetchPickUpFilterUseCase>(
        () => _i76.FetchPickUpFilterUseCase(gh<_i38.FilterService>()));
    gh.factory<_i77.FetchSpecialistFilterUseCase>(
        () => _i77.FetchSpecialistFilterUseCase(gh<_i38.FilterService>()));
    gh.factory<_i78.PickUpSpecialistBloc>(() => _i78.PickUpSpecialistBloc(
          gh<_i76.FetchPickUpFilterUseCase>(),
          gh<_i48.PickUpFilterController>(),
        ));
    gh.factory<_i79.SpecialistFilterBloc>(() => _i79.SpecialistFilterBloc(
          gh<_i77.FetchSpecialistFilterUseCase>(),
    ...
    gh.factory<_i81.UserService>(() => _i82.FirebaseUserService(
          gh<_i58.UserRepository>(),
          gh<_i7.Factory<_i69.Future<_i70.UserModel>, _i71.UserModelDto>>(),
        ));
    gh.factory<_i83.ChatBloc>(() => _i83.ChatBloc(
          gh<_i65.ChatService>(),
          gh<_i34.FilePickerService>(),
          gh<_i57.UserController>(),
        ));
    gh.factory<_i84.CreditCardBloc>(() => _i84.CreditCardBloc(
          gh<_i68.CreditCardSaveUseCase>(),
          gh<_i67.CreditCardListFetchUseCase>(),
          gh<_i57.UserController>(),
        ));
    gh.factory<
            _i7.Factory<_i69.Future<_i24.ReviewModel?>, _i23.ReviewModelDto>>(
        () => _i85.ReviewModelFromDto(gh<_i81.UserService>()));
    gh.factory<_i86.GetCurrentUserUseCase>(
        () => _i86.GetCurrentUserUseCase(gh<_i81.UserService>()));
    gh.factory<_i87.LogOutUseCase>(
        () => _i87.LogOutUseCase(gh<_i81.UserService>()));
    gh.factory<_i88.PinCodeChangeUseCase>(
        () => _i88.PinCodeChangeUseCase(gh<_i81.UserService>()));
    gh.factory<_i89.SpecialistService>(() => _i90.FirebaseSpecialistService(
          gh<_i50.SpecialistRepository>(),
          gh<
              _i7.Factory<_i69.Future<_i73.SpecialistModel>,
                  _i74.SpecialistModelDto>>(),
          gh<_i7.Factory<_i31.FilterPreferencesDto, _i32.FilterPreferences>>(),
          gh<
              _i7.Factory<_i69.Future<_i24.ReviewModel?>,
                  _i23.ReviewModelDto>>(),
          gh<_i7.Factory<_i23.ReviewModelDto, _i24.ReviewModel>>(),
        ));
    gh.factory<_i91.UpdateReviewUseCase>(
        () => _i91.UpdateReviewUseCase(gh<_i89.SpecialistService>()));
    gh.factory<_i92.UserBloc>(() => _i92.UserBloc(
          gh<_i86.GetCurrentUserUseCase>(),
          gh<_i87.LogOutUseCase>(),
          gh<_i57.UserController>(),
        ));
    gh.factory<_i93.AddReviewUseCase>(
        () => _i93.AddReviewUseCase(gh<_i89.SpecialistService>()));
    gh.factory<_i94.AddToFavoriteUseCase>(
        () => _i94.AddToFavoriteUseCase(gh<_i89.SpecialistService>()));
    gh.factory<_i95.DeleteReviewUseCase>(
        () => _i95.DeleteReviewUseCase(gh<_i89.SpecialistService>()));
    gh.factory<_i7.Factory<_i69.Future<_i9.BookingData?>, _i8.BookingDataDto>>(
        () => _i96.BookingDataFromDto(gh<_i89.SpecialistService>()));
    gh.factory<_i97.FetchFavoriteListUseCase>(
        () => _i97.FetchFavoriteListUseCase(gh<_i89.SpecialistService>()));
    gh.factory<_i98.FetchSpecialistCatalogueUseCase>(() =>
        _i98.FetchSpecialistCatalogueUseCase(gh<_i89.SpecialistService>()));
    gh.factory<_i99.FetchSpecialistReviewsUseCase>(
        () => _i99.FetchSpecialistReviewsUseCase(gh<_i89.SpecialistService>()));
    gh.factory<_i100.FetchSpecialistsOnlineUseCase>(() =>
        _i100.FetchSpecialistsOnlineUseCase(gh<_i89.SpecialistService>()));
    gh.factory<_i101.PinCodeBloc>(() => _i101.PinCodeBloc(
          gh<_i57.UserController>(),
          gh<_i88.PinCodeChangeUseCase>(),
        ));
    gh.factory<_i102.RemoveFromFavoriteUseCase>(
        () => _i102.RemoveFromFavoriteUseCase(gh<_i89.SpecialistService>()));
    gh.factory<_i103.ReviewBloc>(() => _i103.ReviewBloc(
          gh<_i99.FetchSpecialistReviewsUseCase>(),
          gh<_i93.AddReviewUseCase>(),
          gh<_i57.UserController>(),
          gh<_i49.SpecialistRatingController>(),
          gh<_i91.UpdateReviewUseCase>(),
          gh<_i95.DeleteReviewUseCase>(),
        ));
    gh.factory<_i104.SpecialistCatalogueBloc>(
        () => _i104.SpecialistCatalogueBloc(
              gh<_i98.FetchSpecialistCatalogueUseCase>(),
              gh<_i3.AppliedFilterController>(),
              gh<_i49.SpecialistRatingController>(),
            ));
    gh.factory<_i105.SpecialistOnlineBloc>(() => _i105.SpecialistOnlineBloc(
          gh<_i100.FetchSpecialistsOnlineUseCase>(),
          gh<_i49.SpecialistRatingController>(),
        ));
    gh.factory<_i106.BookingService>(() => _i107.FirebaseBookingService(
          gh<_i5.BookingRepository>(),
          gh<
              _i7.Factory<_i17.SpecialistWorkInfo,
                  _i18.SpecialistWorkInfoDto>>(),
          gh<_i7.Factory<_i8.BookingDataDto, _i9.BookingData>>(),
          gh<_i7.Factory<_i69.Future<_i9.BookingData?>, _i8.BookingDataDto>>(),
        ));
    gh.factory<_i108.FavoriteBloc>(() => _i108.FavoriteBloc(
          gh<_i57.UserController>(),
          gh<_i97.FetchFavoriteListUseCase>(),
          gh<_i94.AddToFavoriteUseCase>(),
          gh<_i102.RemoveFromFavoriteUseCase>(),
        ));
    gh.factory<_i109.FetchPreviousSessionsUseCase>(
        () => _i109.FetchPreviousSessionsUseCase(gh<_i106.BookingService>()));
    gh.factory<_i110.FetchUpcomingSessionsUseCase>(
        () => _i110.FetchUpcomingSessionsUseCase(gh<_i106.BookingService>()));
    gh.factory<_i111.PreviousSessionsBloc>(() => _i111.PreviousSessionsBloc(
          gh<_i109.FetchPreviousSessionsUseCase>(),
          gh<_i57.UserController>(),
        ));
    gh.factory<_i112.SpecialistWorkInfoFetchUseCase>(
        () => _i112.SpecialistWorkInfoFetchUseCase(gh<_i106.BookingService>()));
    gh.factory<_i113.UpcomingSessionsBloc>(() => _i113.UpcomingSessionsBloc(
          gh<_i110.FetchUpcomingSessionsUseCase>(),
          gh<_i57.UserController>(),
          gh<_i4.BookingController>(),
        ));
    gh.factory<_i114.WorkInfoBloc>(
        () => _i114.WorkInfoBloc(gh<_i112.SpecialistWorkInfoFetchUseCase>()));
    gh.factory<_i115.BookingBookUseCase>(
        () => _i115.BookingBookUseCase(gh<_i106.BookingService>()));
    gh.factory<_i116.BookingCancelUseCase>(
        () => _i116.BookingCancelUseCase(gh<_i106.BookingService>()));
    gh.factory<_i117.BookingRescheduleUseCase>(
        () => _i117.BookingRescheduleUseCase(gh<_i106.BookingService>()));
    gh.factory<_i118.BookingBloc>(() => _i118.BookingBloc(
          gh<_i115.BookingBookUseCase>(),
          gh<_i117.BookingRescheduleUseCase>(),
          gh<_i116.BookingCancelUseCase>(),
          gh<_i57.UserController>(),
          gh<_i4.BookingController>(),
        ));
    return this;
