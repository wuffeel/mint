...
import 'package:mint/domain/service/abstract/storage_service.dart' as _i18;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.factory<_i18.StorageService>(
        () => _i19.FirebaseStorageService(gh<_i16.StorageRepository>()));
    ...
    gh.factory<_i25.VerifyOtpUseCase>(
        () => _i25.VerifyOtpUseCase(gh<_i12.PhoneAuthService>()));
    gh.factory<_i26.VerifyPhoneUseCase>(
        () => _i26.VerifyPhoneUseCase(gh<_i12.PhoneAuthService>()));
