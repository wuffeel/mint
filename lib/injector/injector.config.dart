...
import 'package:mint/assembly/entity/review_model_from_dto.dart' as _i36;
import 'package:mint/assembly/entity/specialist_filter_from_dto.dart' as _i39;
...
import 'package:mint/assembly/model/filter_preferences_to_dto.dart' as _i31;
...
import 'package:mint/bloc/notifications/notifications_bloc.dart' as _i110;
...
import 'package:mint/bloc/upcoming_sessions/upcoming_sessions_bloc.dart'
    as _i113;
import 'package:mint/bloc/user/user_bloc.dart' as _i102;
...
import 'package:mint/domain/service/abstract/booking_service.dart' as _i103;
...
import 'package:mint/domain/usecase/fetch_favorite_list_use_case.dart' as _i84;
import 'package:mint/domain/usecase/fetch_pick_up_filter_use_case.dart' as _i85;
import 'package:mint/domain/usecase/fetch_previous_sessions_use_case.dart'
    as _i107;
import 'package:mint/domain/usecase/fetch_session_data_use_case.dart' as _i108;
...
import 'package:mint/domain/usecase/fetch_specialist_reviews_use_case.dart'
    as _i88;
import 'package:mint/domain/usecase/fetch_specialist_use_case.dart' as _i89;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.factory<
            _i13.Factory<_i17.SpecialistWorkInfo, _i18.SpecialistWorkInfoDto>>(
        () => _i19.SpecialistWorkInfoFromDto());
    gh.factory<_i13.Factory<_i20.BookingDataDto, _i21.BookingData>>(
        () => _i22.BookingDataToDto());
    gh.factory<_i13.Factory<_i23.CreditCardModel, _i24.CreditCardModelDto>>(
        () => _i25.CreditCardModelFromDto());
    gh.factory<_i13.Factory<_i26.PickUpFilter, _i27.PickUpFilterDto>>(
        () => _i28.PickUpFilterFromDto());
    gh.factory<_i13.Factory<_i29.FilterPreferencesDto, _i30.FilterPreferences>>(
        () => _i31.FilterPreferencesToDto());
    gh.factory<_i13.Factory<_i32.ReviewModelDto, _i33.ReviewModel>>(
        () => _i34.ReviewModelToDto());
    gh.factory<
            _i13.Factory<_i35.Future<_i33.ReviewModel?>, _i32.ReviewModelDto>>(
        () => _i36.ReviewModelFromDto(gh<_i3.UserService>()));
    gh.factory<_i13.Factory<_i37.SpecialistFilter, _i38.SpecialistFilterDto>>(
        () => _i39.SpecialistFilterFromDto());
    ...
    gh.factory<_i42.FilterService>(() => _i43.FirebaseFilterService(
          ...
          gh<_i13.Factory<_i37.SpecialistFilter, _i38.SpecialistFilterDto>>(),
    ...
    gh.factory<_i53.PaymentService>(() => _i54.FirebasePaymentService(
          ...
          gh<_i13.Factory<_i23.CreditCardModel, _i24.CreditCardModelDto>>(),
    ...
    gh.factory<_i64.SpecialistService>(() => _i65.FirebaseSpecialistService(
          ...
          gh<
              _i13.Factory<_i35.Future<_i66.SpecialistModel>,
                  _i66.SpecialistModelDto>>(),
          gh<_i13.Factory<_i29.FilterPreferencesDto, _i30.FilterPreferences>>(),
          gh<
              _i13.Factory<_i35.Future<_i33.ReviewModel?>,
                  _i32.ReviewModelDto>>(),
          gh<_i13.Factory<_i32.ReviewModelDto, _i33.ReviewModel>>(),
        ));
    ...
    gh.factory<
            _i13.Factory<_i35.Future<_i21.BookingData?>, _i20.BookingDataDto>>(
        () => _i83.BookingDataFromDto(gh<_i64.SpecialistService>()));
    gh.factory<_i84.FetchFavoriteListUseCase>(
        () => _i84.FetchFavoriteListUseCase(gh<_i64.SpecialistService>()));
    gh.factory<_i85.FetchPickUpFilterUseCase>(
        () => _i85.FetchPickUpFilterUseCase(gh<_i42.FilterService>()));
    gh.factory<_i86.FetchSpecialistCatalogueUseCase>(() =>
        _i86.FetchSpecialistCatalogueUseCase(gh<_i64.SpecialistService>()));
    gh.factory<_i87.FetchSpecialistFilterUseCase>(
        () => _i87.FetchSpecialistFilterUseCase(gh<_i42.FilterService>()));
    gh.factory<_i88.FetchSpecialistReviewsUseCase>(
        () => _i88.FetchSpecialistReviewsUseCase(gh<_i64.SpecialistService>()));
    gh.factory<_i89.FetchSpecialistUseCase>(
        () => _i89.FetchSpecialistUseCase(gh<_i64.SpecialistService>()));
    gh.factory<_i90.FetchSpecialistsOnlineUseCase>(
        () => _i90.FetchSpecialistsOnlineUseCase(gh<_i64.SpecialistService>()));
    gh.factory<_i91.GetBookingNotificationsStreamUseCase>(() =>
        _i91.GetBookingNotificationsStreamUseCase(
            gh<_i49.NotificationService>()));
    gh.factory<_i92.GetChatNotificationsStreamUseCase>(() =>
        _i92.GetChatNotificationsStreamUseCase(gh<_i49.NotificationService>()));
    gh.factory<_i93.InitializeNotificationsUseCase>(() =>
        _i93.InitializeNotificationsUseCase(gh<_i49.NotificationService>()));
    gh.factory<_i94.PickUpSpecialistBloc>(() => _i94.PickUpSpecialistBloc(
          gh<_i85.FetchPickUpFilterUseCase>(),
    ...
    gh.factory<_i96.RemoveFromFavoriteUseCase>(
        () => _i96.RemoveFromFavoriteUseCase(gh<_i64.SpecialistService>()));
    gh.factory<_i97.ReviewBloc>(() => _i97.ReviewBloc(
          gh<_i88.FetchSpecialistReviewsUseCase>(),
    ...
    gh.factory<_i102.UserBloc>(() => _i102.UserBloc(
          gh<_i44.GetCurrentUserUseCase>(),
          gh<_i46.LogOutUseCase>(),
          gh<_i71.UserDataUpdateUseCase>(),
          gh<_i78.UserController<_i66.PatientUser?>>(),
        ));
    gh.factory<_i103.BookingService>(() => _i104.FirebaseBookingService(
          gh<_i11.BookingRepository>(),
          gh<
              _i13.Factory<_i17.SpecialistWorkInfo,
                  _i18.SpecialistWorkInfoDto>>(),
          gh<_i13.Factory<_i20.BookingDataDto, _i21.BookingData>>(),
          gh<
              _i13.Factory<_i35.Future<_i21.BookingData?>,
                  _i20.BookingDataDto>>(),
        ));
    ...
    gh.factory<_i106.FavoriteBloc>(() => _i106.FavoriteBloc(
          gh<_i78.UserController<_i66.PatientUser?>>(),
          gh<_i84.FetchFavoriteListUseCase>(),
          gh<_i75.AddToFavoriteUseCase>(),
          gh<_i96.RemoveFromFavoriteUseCase>(),
        ));
    gh.factory<_i107.FetchPreviousSessionsUseCase>(
        () => _i107.FetchPreviousSessionsUseCase(gh<_i103.BookingService>()));
    gh.factory<_i108.FetchSessionDataUseCase>(
        () => _i108.FetchSessionDataUseCase(gh<_i103.BookingService>()));
    gh.factory<_i109.FetchUpcomingSessionsUseCase>(
        () => _i109.FetchUpcomingSessionsUseCase(gh<_i103.BookingService>()));
    gh.factory<_i110.NotificationsBloc>(() => _i110.NotificationsBloc(
          gh<_i93.InitializeNotificationsUseCase>(),
          gh<_i78.UserController<_i66.PatientUser?>>(),
          gh<_i3.FetchChatRoomUseCase>(),
          gh<_i108.FetchSessionDataUseCase>(),
          gh<_i92.GetChatNotificationsStreamUseCase>(),
          gh<_i91.GetBookingNotificationsStreamUseCase>(),
        ));
    ...
    gh.factory<_i112.SpecialistWorkInfoFetchUseCase>(
        () => _i112.SpecialistWorkInfoFetchUseCase(gh<_i103.BookingService>()));
    ...
    gh.factory<_i115.BookingBookUseCase>(
        () => _i115.BookingBookUseCase(gh<_i103.BookingService>()));
    gh.factory<_i116.BookingCancelUseCase>(
        () => _i116.BookingCancelUseCase(gh<_i103.BookingService>()));
    gh.factory<_i117.BookingRescheduleUseCase>(
        () => _i117.BookingRescheduleUseCase(gh<_i103.BookingService>()));
