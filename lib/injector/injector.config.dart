...
import 'package:mint/assembly/entity/pick_up_filter_from_dto.dart' as _i12;
import 'package:mint/assembly/entity/review_model_from_dto.dart' as _i64;
import 'package:mint/assembly/entity/specialist_filter_from_dto.dart' as _i9;
...
import 'package:mint/assembly/entity/specialist_work_info_from_dto.dart'
    as _i15;
import 'package:mint/assembly/entity/user_model_from_dto.dart' as _i55;
import 'package:mint/assembly/factory.dart' as _i6;
import 'package:mint/assembly/model/booking_model_to_dto.dart' as _i24;
...
import 'package:mint/data/model/specialist_work_info_dto/specialist_work_info_dto.dart'
    as _i14;
import 'package:mint/data/model/user_model_dto/user_model_dto.dart' as _i54;
...
import 'package:mint/domain/entity/filter_preferences/filter_preferences.dart'
    as _i20;
import 'package:mint/domain/entity/pick_up_filter/pick_up_filter.dart' as _i10;
...
import 'package:mint/domain/entity/specialist_work_info/specialist_work_info.dart'
    as _i13;
import 'package:mint/domain/entity/user_model/user_model.dart' as _i53;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.factory<_i6.Factory<_i7.SpecialistFilter, _i8.SpecialistFilterDto>>(
        () => _i9.SpecialistFilterFromDto());
    gh.factory<_i6.Factory<_i10.PickUpFilter, _i11.PickUpFilterDto>>(
        () => _i12.PickUpFilterFromDto());
    gh.factory<
    ...
    gh.factory<_i6.Factory<_i22.BookingDataDto, _i23.BookingData>>(
        () => _i24.BookingModelToDto());
    ...
    gh.factory<_i27.FilterService>(() => _i28.FirebaseFilterService(
          ...
          gh<_i6.Factory<_i7.SpecialistFilter, _i8.SpecialistFilterDto>>(),
          gh<_i6.Factory<_i10.PickUpFilter, _i11.PickUpFilterDto>>(),
        ));
    ...
    gh.factory<_i47.BookingService>(() => _i48.FirebaseBookingService(
          ...
          gh<_i6.Factory<_i22.BookingDataDto, _i23.BookingData>>(),
        ));
    gh.factory<
            _i6.Factory<_i49.Future<_i50.SpecialistModel>,
                _i51.SpecialistModelDto>>(
        () => _i52.SpecialistModelFromDto(gh<_i39.StorageService>()));
    gh.factory<_i6.Factory<_i49.Future<_i53.UserModel>, _i54.UserModelDto>>(
        () => _i55.UserModelFromDto(gh<_i39.StorageService>()));
    ...
    gh.factory<_i60.UserService>(() => _i61.FirebaseUserService(
          ...
          gh<_i6.Factory<_i49.Future<_i53.UserModel>, _i54.UserModelDto>>(),
        ));
    ...
    gh.factory<
            _i6.Factory<_i49.Future<_i17.ReviewModel?>, _i16.ReviewModelDto>>(
    ...
    gh.factory<_i68.SpecialistService>(() => _i69.FirebaseSpecialistService(
          ...
          gh<
              _i6.Factory<_i49.Future<_i17.ReviewModel?>,
                  _i16.ReviewModelDto>>(),
