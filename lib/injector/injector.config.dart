...
import 'package:mint/assembly/entity/pick_up_filter_from_dto.dart' as _i23;
import 'package:mint/assembly/entity/review_model_from_dto.dart' as _i20;
...
import 'package:mint/assembly/model/review_model_to_dto.dart' as _i33;
import 'package:mint/assembly/model/transaction_data_to_dto.dart' as _i32;
...
import 'package:mint/data/model/booking_data_dto/booking_data_dto.dart' as _i27;
...
import 'package:mint/domain/entity/filter_preferences/filter_preferences.dart'
    as _i15;
import 'package:mint/domain/entity/pick_up_filter/pick_up_filter.dart' as _i21;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.factory<
            _i13.Factory<_i17.Future<_i18.ReviewModel?>, _i19.ReviewModelDto>>(
        () => _i20.ReviewModelFromDto(gh<_i3.UserService>()));
    gh.factory<_i13.Factory<_i21.PickUpFilter, _i22.PickUpFilterDto>>(
        () => _i23.PickUpFilterFromDto());
    gh.factory<_i13.Factory<_i24.CreditCardModel, _i25.CreditCardModelDto>>(
        () => _i26.CreditCardModelFromDto());
    gh.factory<_i13.Factory<_i27.BookingDataDto, _i28.BookingData>>(
        () => _i29.BookingDataToDto());
    gh.factory<_i13.Factory<_i30.TransactionDataDto, _i31.TransactionData>>(
        () => _i32.TransactionDataToDto());
    gh.factory<_i13.Factory<_i19.ReviewModelDto, _i18.ReviewModel>>(
        () => _i33.ReviewModelToDto());
    gh.factory<_i13.Factory<_i34.SpecialistFilter, _i35.SpecialistFilterDto>>(
    ...
    gh.factory<_i39.FilterService>(() => _i40.FirebaseFilterService(
          ...
          gh<_i13.Factory<_i34.SpecialistFilter, _i35.SpecialistFilterDto>>(),
          gh<_i13.Factory<_i21.PickUpFilter, _i22.PickUpFilterDto>>(),
        ));
    ...
    gh.factory<_i50.PaymentService>(() => _i51.FirebasePaymentService(
          ...
          gh<_i13.Factory<_i24.CreditCardModel, _i25.CreditCardModelDto>>(),
          gh<_i13.Factory<_i30.TransactionDataDto, _i31.TransactionData>>(),
        ));
    ...
    gh.factory<_i61.SpecialistService>(() => _i62.FirebaseSpecialistService(
          ...
          gh<
              _i13.Factory<_i17.Future<_i63.SpecialistModel>,
                  _i63.SpecialistModelDto>>(),
          gh<_i13.Factory<_i14.FilterPreferencesDto, _i15.FilterPreferences>>(),
          gh<
              _i13.Factory<_i17.Future<_i18.ReviewModel?>,
                  _i19.ReviewModelDto>>(),
          gh<_i13.Factory<_i19.ReviewModelDto, _i18.ReviewModel>>(),
        ));
    ...
    gh.factory<
            _i13.Factory<_i17.Future<_i28.BookingData?>, _i27.BookingDataDto>>(
    ...
    gh.factory<_i102.BookingService>(() => _i103.FirebaseBookingService(
          ...
          gh<_i13.Factory<_i27.BookingDataDto, _i28.BookingData>>(),
          gh<
              _i13.Factory<_i17.Future<_i28.BookingData?>,
                  _i27.BookingDataDto>>(),
        ));
    ...
    gh.factory<_i112.AppNotificationsBlocPatient>(
        () => _i112.AppNotificationsBlocPatient(
              gh<_i113.GetAppNotificationStreamUseCase>(),
              gh<_i3.FetchChatRoomUseCase>(),
              gh<_i114.MarkAppNotificationAsReadUseCase>(),
              gh<_i115.ClearAppNotificationsUseCase>(),
              gh<_i76.UserController<_i63.PatientUser?>>(),
              gh<_i107.FetchSessionDataUseCase>(),
            ));
    gh.factory<_i116.BookingBookUseCase>(
        () => _i116.BookingBookUseCase(gh<_i102.BookingService>()));
    gh.factory<_i117.BookingCancelUseCase>(
        () => _i117.BookingCancelUseCase(gh<_i102.BookingService>()));
    gh.factory<_i118.BookingRescheduleUseCase>(
        () => _i118.BookingRescheduleUseCase(gh<_i102.BookingService>()));
