...
import 'package:mint/assembly/entity/booking_data_from_dto.dart' as _i22;
import 'package:mint/assembly/entity/credit_card_model_from_dto.dart' as _i9;
import 'package:mint/assembly/entity/pick_up_filter_from_dto.dart' as _i25;
import 'package:mint/assembly/entity/review_model_from_dto.dart' as _i79;
...
import 'package:mint/assembly/model/booking_data_to_dto.dart' as _i18;
...
import 'package:mint/bloc/auth/auth_bloc.dart' as _i57;
import 'package:mint/bloc/booking/booking_bloc.dart' as _i90;
import 'package:mint/bloc/credit_card/credit_card_bloc.dart' as _i78;
...
import 'package:mint/bloc/specialist_online/specialist_online_bloc.dart'
    as _i100;
import 'package:mint/bloc/transaction/transaction_bloc.dart' as _i85;
import 'package:mint/bloc/user/user_bloc.dart' as _i87;
import 'package:mint/data/model/booking_data_dto/booking_data_dto.dart' as _i16;
...
import 'package:mint/data/repository/abstract/user_repository.dart' as _i53;
...
import 'package:mint/domain/controller/specialist_rating_controller.dart'
    as _i45;
import 'package:mint/domain/controller/user_controller.dart' as _i52;
import 'package:mint/domain/entity/booking_data/booking_data.dart' as _i17;
...
import 'package:mint/domain/service/abstract/booking_service.dart' as _i58;
...
import 'package:mint/domain/service/abstract/specialist_service.dart' as _i83;
...
import 'package:mint/domain/usecase/booking_book_use_case.dart' as _i76;
import 'package:mint/domain/usecase/booking_info_fetch_use_case.dart' as _i77;
...
import 'package:mint/domain/usecase/fetch_specialists_online_use_case.dart'
    as _i95;
import 'package:mint/domain/usecase/get_current_user_use_case.dart' as _i80;
import 'package:mint/domain/usecase/log_out_use_case.dart' as _i81;
import 'package:mint/domain/usecase/pin_code_change_use_case.dart' as _i82;
import 'package:mint/domain/usecase/remove_from_favorite_use_case.dart' as _i97;
import 'package:mint/domain/usecase/transaction_pay_use_case.dart' as _i73;
import 'package:mint/domain/usecase/update_review_use_case.dart' as _i86;
import 'package:mint/domain/usecase/verify_otp_use_case.dart' as _i55;
import 'package:mint/domain/usecase/verify_phone_use_case.dart' as _i56;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.factory<_i6.Factory<_i7.CreditCardModel, _i8.CreditCardModelDto>>(
        () => _i9.CreditCardModelFromDto());
    gh.factory<_i6.Factory<_i10.FilterPreferencesDto, _i11.FilterPreferences>>(
        () => _i12.FilterPreferencesToDto());
    gh.factory<_i6.Factory<_i13.TransactionDataDto, _i14.TransactionData>>(
        () => _i15.TransactionDataToDto());
    gh.factory<_i6.Factory<_i16.BookingDataDto, _i17.BookingData>>(
        () => _i18.BookingDataToDto());
    gh.factory<
            _i6.Factory<_i19.SpecialistWorkInfo, _i20.SpecialistWorkInfoDto>>(
        () => _i21.SpecialistWorkInfoFromDto());
    gh.factory<_i6.Factory<_i17.BookingData, _i16.BookingDataDto>>(
        () => _i22.BookingDataFromDto());
    gh.factory<_i6.Factory<_i23.PickUpFilter, _i24.PickUpFilterDto>>(
        () => _i25.PickUpFilterFromDto());
    gh.factory<_i6.Factory<_i26.SpecialistFilter, _i27.SpecialistFilterDto>>(
        () => _i28.SpecialistFilterFromDto());
    gh.factory<_i6.Factory<_i29.ReviewModelDto, _i30.ReviewModel>>(
    ...
    gh.factory<_i34.FilterService>(() => _i35.FirebaseFilterService(
          ...
          gh<_i6.Factory<_i26.SpecialistFilter, _i27.SpecialistFilterDto>>(),
    ...
    gh.factory<_i38.PaymentService>(() => _i39.FirebasePaymentService(
          ...
          gh<_i6.Factory<_i7.CreditCardModel, _i8.CreditCardModelDto>>(),
        ));
    ...
    gh.lazySingleton<_i52.UserController>(() => _i52.UserController());
    gh.factory<_i53.UserRepository>(() => _i54.FirebaseUserRepository());
    gh.factory<_i55.VerifyOtpUseCase>(
        () => _i55.VerifyOtpUseCase(gh<_i42.PhoneAuthService>()));
    gh.factory<_i56.VerifyPhoneUseCase>(
        () => _i56.VerifyPhoneUseCase(gh<_i42.PhoneAuthService>()));
    gh.factory<_i57.AuthBloc>(() => _i57.AuthBloc(
          gh<_i56.VerifyPhoneUseCase>(),
          gh<_i55.VerifyOtpUseCase>(),
          gh<_i52.UserController>(),
        ));
    gh.factory<_i58.BookingService>(() => _i59.FirebaseBookingService(
          gh<_i4.BookingRepository>(),
          gh<
              _i6.Factory<_i19.SpecialistWorkInfo,
                  _i20.SpecialistWorkInfoDto>>(),
          gh<_i6.Factory<_i16.BookingDataDto, _i17.BookingData>>(),
          gh<_i6.Factory<_i17.BookingData, _i16.BookingDataDto>>(),
          gh<_i6.Factory<_i13.TransactionDataDto, _i14.TransactionData>>(),
        ));
    gh.factory<_i60.CreditCardListFetchUseCase>(
        () => _i60.CreditCardListFetchUseCase(gh<_i38.PaymentService>()));
    gh.factory<_i61.CreditCardSaveUseCase>(
        () => _i61.CreditCardSaveUseCase(gh<_i38.PaymentService>()));
    gh.factory<_i6.Factory<_i62.Future<_i63.UserModel>, _i64.UserModelDto>>(
        () => _i65.UserModelFromDto(gh<_i50.StorageService>()));
    gh.factory<
            _i6.Factory<_i62.Future<_i66.SpecialistModel>,
                _i67.SpecialistModelDto>>(
        () => _i68.SpecialistModelFromDto(gh<_i50.StorageService>()));
    gh.factory<_i69.FetchPickUpFilterUseCase>(
        () => _i69.FetchPickUpFilterUseCase(gh<_i34.FilterService>()));
    gh.factory<_i70.FetchSpecialistFilterUseCase>(
        () => _i70.FetchSpecialistFilterUseCase(gh<_i34.FilterService>()));
    ...
    gh.factory<_i73.TransactionPayUseCase>(
        () => _i73.TransactionPayUseCase(gh<_i58.BookingService>()));
    gh.factory<_i74.UserService>(() => _i75.FirebaseUserService(
          gh<_i53.UserRepository>(),
          gh<_i6.Factory<_i62.Future<_i63.UserModel>, _i64.UserModelDto>>(),
        ));
    gh.factory<_i76.BookingBookUseCase>(
        () => _i76.BookingBookUseCase(gh<_i58.BookingService>()));
    gh.factory<_i77.BookingInfoFetchUseCase>(
        () => _i77.BookingInfoFetchUseCase(gh<_i58.BookingService>()));
    gh.factory<_i78.CreditCardBloc>(() => _i78.CreditCardBloc(
          gh<_i61.CreditCardSaveUseCase>(),
          gh<_i60.CreditCardListFetchUseCase>(),
          gh<_i52.UserController>(),
        ));
    gh.factory<
            _i6.Factory<_i62.Future<_i30.ReviewModel?>, _i29.ReviewModelDto>>(
        () => _i79.ReviewModelFromDto(gh<_i74.UserService>()));
    gh.factory<_i80.GetCurrentUserUseCase>(
        () => _i80.GetCurrentUserUseCase(gh<_i74.UserService>()));
    gh.factory<_i81.LogOutUseCase>(
        () => _i81.LogOutUseCase(gh<_i74.UserService>()));
    gh.factory<_i82.PinCodeChangeUseCase>(
        () => _i82.PinCodeChangeUseCase(gh<_i74.UserService>()));
    gh.factory<_i83.SpecialistService>(() => _i84.FirebaseSpecialistService(
          ...
          gh<
              _i6.Factory<_i62.Future<_i30.ReviewModel?>,
                  _i29.ReviewModelDto>>(),
          gh<_i6.Factory<_i29.ReviewModelDto, _i30.ReviewModel>>(),
        ));
    gh.factory<_i85.TransactionBloc>(() => _i85.TransactionBloc(
          gh<_i73.TransactionPayUseCase>(),
          gh<_i52.UserController>(),
        ));
    gh.factory<_i86.UpdateReviewUseCase>(
        () => _i86.UpdateReviewUseCase(gh<_i83.SpecialistService>()));
    gh.factory<_i87.UserBloc>(() => _i87.UserBloc(
          gh<_i80.GetCurrentUserUseCase>(),
          gh<_i81.LogOutUseCase>(),
          gh<_i52.UserController>(),
        ));
    gh.factory<_i88.AddReviewUseCase>(
        () => _i88.AddReviewUseCase(gh<_i83.SpecialistService>()));
    gh.factory<_i89.AddToFavoriteUseCase>(
        () => _i89.AddToFavoriteUseCase(gh<_i83.SpecialistService>()));
    gh.factory<_i90.BookingBloc>(() => _i90.BookingBloc(
          gh<_i52.UserController>(),
          gh<_i77.BookingInfoFetchUseCase>(),
          gh<_i76.BookingBookUseCase>(),
        ));
    gh.factory<_i91.DeleteReviewUseCase>(
        () => _i91.DeleteReviewUseCase(gh<_i83.SpecialistService>()));
    gh.factory<_i92.FetchFavoriteListUseCase>(
        () => _i92.FetchFavoriteListUseCase(gh<_i83.SpecialistService>()));
    gh.factory<_i93.FetchSpecialistCatalogueUseCase>(() =>
        _i93.FetchSpecialistCatalogueUseCase(gh<_i83.SpecialistService>()));
    gh.factory<_i94.FetchSpecialistReviewsUseCase>(
        () => _i94.FetchSpecialistReviewsUseCase(gh<_i83.SpecialistService>()));
    gh.factory<_i95.FetchSpecialistsOnlineUseCase>(
        () => _i95.FetchSpecialistsOnlineUseCase(gh<_i83.SpecialistService>()));
    gh.factory<_i96.PinCodeBloc>(() => _i96.PinCodeBloc(
          gh<_i52.UserController>(),
          gh<_i82.PinCodeChangeUseCase>(),
        ));
    gh.factory<_i97.RemoveFromFavoriteUseCase>(
        () => _i97.RemoveFromFavoriteUseCase(gh<_i83.SpecialistService>()));
