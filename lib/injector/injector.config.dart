...
import 'package:mint/assembly/model/review_model_to_dto.dart' as _i28;
...
import 'package:mint/bloc/booking/booking_bloc.dart' as _i109;
...
import 'package:mint/bloc/work_info/work_info_bloc.dart' as _i105;
...
import 'package:mint/data/model/pick_up_filter_dto/pick_up_filter_dto.dart'
    as _i12;
import 'package:mint/data/model/review_model_dto/review_model_dto.dart' as _i26;
...
import 'package:mint/domain/entity/review_model/review_model.dart' as _i27;
...
import 'package:mint/domain/usecase/booking_cancel_use_case.dart' as _i107;
import 'package:mint/domain/usecase/booking_reschedule_use_case.dart' as _i108;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.factory<_i7.Factory<_i11.PickUpFilter, _i12.PickUpFilterDto>>(
    ...
    gh.factory<_i7.Factory<_i26.ReviewModelDto, _i27.ReviewModel>>(
        () => _i28.ReviewModelToDto());
    gh.factory<_i7.Factory<_i29.FilterPreferencesDto, _i30.FilterPreferences>>(
    ...
    gh.factory<_i34.FilterService>(() => _i35.FirebaseFilterService(
          ...
          gh<_i7.Factory<_i11.PickUpFilter, _i12.PickUpFilterDto>>(),
        ));
    ...
    gh.factory<_i7.Factory<_i61.Future<_i62.UserModel>, _i63.UserModelDto>>(
        () => _i64.UserModelFromDto(gh<_i50.StorageService>()));
    gh.factory<
            _i7.Factory<_i61.Future<_i65.SpecialistModel>,
    ...
    gh.factory<_i73.UserService>(() => _i74.FirebaseUserService(
          ...
          gh<_i7.Factory<_i61.Future<_i62.UserModel>, _i63.UserModelDto>>(),
        ));
    ...
    gh.factory<
            _i7.Factory<_i61.Future<_i27.ReviewModel?>, _i26.ReviewModelDto>>(
    ...
    gh.factory<_i80.SpecialistService>(() => _i81.FirebaseSpecialistService(
          ...
          gh<
              _i7.Factory<_i61.Future<_i65.SpecialistModel>,
                  _i66.SpecialistModelDto>>(),
          gh<_i7.Factory<_i29.FilterPreferencesDto, _i30.FilterPreferences>>(),
          gh<
              _i7.Factory<_i61.Future<_i27.ReviewModel?>,
                  _i26.ReviewModelDto>>(),
          gh<_i7.Factory<_i26.ReviewModelDto, _i27.ReviewModel>>(),
        ));
    ...
    gh.factory<
            _i7.Factory<_i61.Future<_i21.BookingData?>, _i20.BookingDataDto>>(
    ...
    gh.factory<_i97.BookingService>(() => _i98.FirebaseBookingService(
          ...
          gh<
              _i7.Factory<_i61.Future<_i21.BookingData?>,
                  _i20.BookingDataDto>>(),
        ));
    ...
    gh.factory<_i105.WorkInfoBloc>(
        () => _i105.WorkInfoBloc(gh<_i103.SpecialistWorkInfoFetchUseCase>()));
    gh.factory<_i106.BookingBookUseCase>(
        () => _i106.BookingBookUseCase(gh<_i97.BookingService>()));
    gh.factory<_i107.BookingCancelUseCase>(
        () => _i107.BookingCancelUseCase(gh<_i97.BookingService>()));
    gh.factory<_i108.BookingRescheduleUseCase>(
        () => _i108.BookingRescheduleUseCase(gh<_i97.BookingService>()));
    gh.factory<_i109.BookingBloc>(() => _i109.BookingBloc(
          gh<_i106.BookingBookUseCase>(),
          gh<_i108.BookingRescheduleUseCase>(),
          gh<_i107.BookingCancelUseCase>(),
          gh<_i53.UserController>(),
          gh<_i4.BookingController>(),
        ));
    return this;
